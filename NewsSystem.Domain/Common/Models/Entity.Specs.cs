...
{ 
    ...
    public class EntitySpecs
    {
        ...
        {
            // Arrange
            var first = new Comment("First Title", "First Content", "Createdby Sechko").SetId(1);
            var second = new Comment("Second Title", "Second Content", "Createdby Bechko").SetId(1);
        ...
        public void EntitiesWithDifferentIdsShouldNotBeEqual()
        {
            // Arrange
            var first = new Comment("First Title", "First Content", "Createdby Sechko").SetId(1);
            var second = new Comment("Second Title", "Second Content", "Createdby Bechko").SetId(2);
